export default function HeroSection() {
  return (
    <section className="bg-gray-100 p-8 text-center h-[calc(100vh-80px)] flex flex-col justify-center items-center">
      <div className="inline-flex items-center px-4 py-2 bg-green-200 dark:bg-primary text-primary dark:text-white rounded-full text-sm font-medium border border-primary-200 dark:border-primary-800">
      ...
      <div>
        <h1 className="mt-4 text-4xl md:text-7xl font-bold text-primary leading-[1.2]">
          আপনার হাতের মুঠোয় <br />
          <span className="text-green-600">নারুয়া বাজারের সব তথ্য</span>
        </h1>
        <p className="w-2xl mx-auto mt-4 text-lg md:text-xl text-gray-700 dark:text-gray-300">
